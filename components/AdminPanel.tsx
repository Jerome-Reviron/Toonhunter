...
export const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const [adminView, setAdminView] = useState<"form" | "stats">("form");
  ...
  return (
    <div className="min-h-screen bg-[#0f0518] p-6 pb-24 text-white">
      <div className="max-w-md mx-auto">
        ...
        {/* ========================= */}
        {adminView === "stats" && (
          <StatsDashboard onBack={() => setAdminView("form")} />
        )}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    {editingId ? "Modifier" : "Vue des locations"}
                  </p>
                </div>
              </div>
              <button
                ...
                <div className="pt-2">
                  <label className="flex items-center justify-between text-sm font-medium mb-2">
                    <span className="flex items-center gap-2">
                      <Ruler className="w-4 h-4 text-pink-400" /> Rayon de
                      capture
                    </span>
